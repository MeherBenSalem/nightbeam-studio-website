...
const REFUSAL_MESSAGE = "I can only help with questions about NightBeam Studio's mods and projects \u2014 like RPG Attribute System and The Birth of Steve. Ask me about installation, configuration, commands, permissions, or how the mod works!";
const MAX_HISTORY_TURNS = 6;
function buildSystemPrompt(catalogIndex, knowledgeBlock) {
...
function buildKnowledgeBlock(chunks, maxTokens) {
